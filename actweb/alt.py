...
# ============================================================
#
# These replace Flask session storage.
#
# WARNING:
# These variables are shared by every user of this Flask process.
# Accessing "/" clears all of them.
#
# If your application is multi-user, this data will be shared
# between users.
# ============================================================
...
def reset_application_data():
    """
    Clears all global application data.

    This is called whenever somebody accesses the homepage.
    """
...
def accommodationSelection():
    ...
    # IMPORTANT:
    #
    # Every time somebody visits the homepage, all global
